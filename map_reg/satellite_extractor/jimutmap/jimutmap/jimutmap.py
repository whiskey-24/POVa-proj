...
class api:
    ...
    def _getAPIKey(self, timeout:float= 60) -> str:
        ...
        # driver = webdriver.Chrome(service=Service(executable_path=chromeDriverPath), options=options)
...
#         lat_rad = math.atan(math.asinh(math.pi * (1 - 2 * int(yTile)/n)))
    ...
    def get_img(self, url_str:str, vNumber:int= 9631, getMask:bool= False, prefix:str= "", _rerun:bool= False):
        """
        ...
        try:
            ...
            try:
                ...
                # https://sat-cdn1.apple-mapkit.com/tile?style=7&size=1&scale=1&z=14&x=11032&y=6616&v=9631&accessKey=1701514495_5111849374140201753_/_LjwpChRRjgL3NXiA4tPC1UD62S9UbYnCzkXC8CCxHaM=
    ...
    def download(self, getMasks:bool= False, latLonResolution:float= 0.0005, **kwargs):
        ...
        file_names = [join(self.container_dir, f"{x}_{y}.jpg") for x,y in URL_ALL]
        self.current_imgs.extend(file_names)
