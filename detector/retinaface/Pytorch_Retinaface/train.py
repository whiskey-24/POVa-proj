...
# --training_dataset /home/whiskey/Documents/2Mit/POVa/POVa-proj/detector/data/20181029_D1_0900_0930/20181029_D1_0900_0930
...
def train():
    ...
    for iteration in range(start_iter, max_iter):
        ...
        print(f'Epoch:{epoch}/{max_epoch} || Epochiter: {(iteration % epoch_size) + 1}/{epoch_size} || Iter: {iteration + 1}/{max_iter} || '
              f'Loc: {loss_l.item():.4f} Cla: {loss_c.item():.4f} Landm: {loss_landm.item():.4f} || LR: {lr:.8f} || Batchtime: {batch_time:.4f} s || '
