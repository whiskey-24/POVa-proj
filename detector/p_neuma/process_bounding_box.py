...
# --base_dir /home/whiskey/Documents/2Mit/POVa/POVa-proj/detector/data/20181029_D1_0900_0930/20181029_D1_0900_0930 --drone 1 --session 3 --rotate_bbox True --save_bbox True --dont_show False
...
if __name__ == '__main__':
    ...
    for idxx, fname in enumerate(file_names[:]):
        print(f"Parsing {idxx+1}/{total}", end="\r", flush=True)
